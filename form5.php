  ...
  <div class="container animated fadeIn">
    ...
    <form id="weddingForm">
      <div class="form-group">
        <label for="theme">Event Type</label>
      ...
      <div class="form-group">
        <label for="budget">Expected Number of Guests</label>
        <input type="number" id="number" name="number of guests" placeholder="Enter the Nuber of Guests">
      </div>
